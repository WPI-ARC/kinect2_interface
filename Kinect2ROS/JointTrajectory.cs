...
namespace ROS_CS
{
    ...
    {
        public class JointTrajectory : ROS_CS.Core.BaseMessage
        {
            public readonly string typeID = "JointTrajectory";
            public readonly string md5sum = "72214029c6fba47b2135714577dd745e";
            public std_msgs.Header header;
            public List<string> joint_names;
            public List<trajectory_msgs.JointTrajectoryPoint> points;
